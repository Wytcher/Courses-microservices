package br.com.authapi.filters;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (StringUtils.hasText(jwt) && tokenService.isTokenValid(jwt)) {
                var userDetails = UserMapper.userToPrincipal(userService.findUserByEmail(tokenService.getTokenUsername(jwt)));
            ...
            throw new BusinessRuleException("Token invalid");
        }
